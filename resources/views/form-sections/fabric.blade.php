...
<span  data-toggle-hidden-target="room-in-attic" class="{{ Input::old('loft-conversion') == "true" ? 'hidden' : '' }}">	
    <div class="col-2 {{ Input::old('flat-or-apartment-above') == "true" ? 'hidden' : '' }}" data-toggle-hidden-target="apartment-above">

        <div class="input-field">
            <label for="loft-insulation" class="input-field__field-title"><span class="input-order-num">9</span>How deep is the insulation in your loft?*</label>
