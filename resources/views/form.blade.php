			...
			<div class="col-2">
				<div class="input-field">
					...
					<div class="btn--toggle-wrapper">
						<input id="loft-conversion" class="btn--toggle" type="checkbox" name="loft-conversion" data-toggle-hidden="data-3a" value='true' {{ Input::old('loft-conversion') == "true" ? 'checked' : '' }}>
			...
			<div class="col-1 hidden cf" data-toggle-hidden-target="data-4a-4b">
				<div class="input-field input-field--hidden cf">
					<div class="col-2">
						...
						<div class="btn--toggle-wrapper">
							<input name="flat-or-apartment-above" type="hidden" value="{{ Input::old('flat-or-apartment-above')}}" class='js-hidden-for-checkbox'>
							<input id="flat-or-apartment-above" class="btn--toggle" name="flat-or-apartment-above" type="checkbox" value='true' {{ Input::old('flat-or-apartment-above') == "true" ? 'checked' : '' }}>
					...
					<div class="col-2">
						...
						<div class="btn--toggle-wrapper">
							<input name="flat-or-apartment-below" type="hidden" value="false" class='js-hidden-for-checkbox'>
							<input id="flat-or-apartment-below" class="btn--toggle" name="flat-or-apartment-below" type="checkbox" value='true' {{ Input::old('flat-or-apartment-below') == "true" ? 'checked' : '' }}>
